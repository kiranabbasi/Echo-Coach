...
// ── Slide 0 — Welcome / Psychology hook ──────────────────────
function Slide0() {
  const stats = [
    { icon: <IconMic color={T.rose600} size={18} />, label: 'Speak daily' },
    { icon: <IconChart color={T.rose600} size={18} />, label: 'Track progress' },
    { icon: <IconCheck color={T.success} size={16} />, label: 'Build confidence' },
  ];

  return (
    <View style={sl.root}>
      <Text style={sl.giant}>∞</Text>
      ...
      <Text style={sl.body}>
        You already know more English than you think. The missing piece is practice, confidence, and someone to talk to every day.
      </Text>
...
function Slide1() {
  ...
  const steps = [
    {
      ...
      desc: 'Echo starts natural conversations and helps you practice like a real person.',
      color: T.rose600,
    },
    {
      n: '02',
      title: 'Improve as you speak',
      desc: 'Get gentle corrections, better words, and feedback without breaking your flow.',
      color: '#0EA5E9',
    },
    {
      n: '03',
      title: 'Grow every day',
      desc: 'Your progress is tracked so you can see yourself becoming more confident.',
      color: T.success,
    },
  ];
  ...
  return (
    <View style={sl.root}>
      ...
      <Text style={sl.sub}>
        A little practice every day creates big changes.
      </Text>
...
// ── Slide 2 — Motivation / user mindset ──────────────────────
function Slide2() {

  const users = [
    {
      name: 'Confidence',
      origin: 'For daily life',
      result: 'Speak freely',
      time: 'Every day',
      quote: '"The best way to learn speaking is to actually speak."',
    },
    {
      name: 'Interviews',
      origin: 'For your career',
      result: 'Answer better',
      time: 'Practice',
      quote: '"Preparation turns nervousness into confidence."',
    },
    {
      name: 'Growth',
      origin: 'For yourself',
      result: 'Improve daily',
      time: 'Small steps',
      quote: '"Consistency beats waiting for the perfect moment."',
    },
  ];
  ...
  return (
    <View style={sl.root}>
      ...
      <Text style={sl.sub}>
        Ask yourself: What could you achieve if speaking English felt easy?
      </Text>
        ...
        {users.map((u) => (
          ...
          <View key={u.name} style={sl.testimonialCard}>
            ...
            <View style={sl.testimonialHeader}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={sl.testimonialName}>
                  {u.name}
                </Text>

                <Text style={sl.testimonialMeta}>
                  {u.origin} · {u.time}
                </Text>
              </View>


              <Text style={sl.testimonialResult}>
                {u.result}
              </Text>
            ...
            <Text style={sl.testimonialQuote}>
              {u.quote}
            </Text>
...
const sl = StyleSheet.create({
  ...
  sub:      { fontFamily: Fonts.regular, fontSize: 14, color: T.slate, marginBottom: 22, lineHeight: 20 },
  ...
  stepDesc:     { fontFamily: Fonts.regular, fontSize: 13, color: T.slate, lineHeight: 19 },
  ...
  testimonialMeta:   { fontFamily: Fonts.regular, fontSize: 11, color: T.slate },
  testimonialResult: { fontFamily: Fonts.semibold, fontSize: 14, color: T.rose500, letterSpacing: -0.3 },
